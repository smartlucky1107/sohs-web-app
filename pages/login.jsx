...
export default function Home() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (res.error) {
      setErrorMessage({ msg: res.error, type: "error" });
    } else {
      setErrorMessage({ msg: "Redirecting...", type: "success" });
  ...
  return (
    <>
      <Head>
        <title>Singapore Occuapational Health Service Company</title>
                  ...
                  <div className="flex items-start">
                    <div className="flex items-center h-5">
                      <input
                        ...
                        type="checkbox"
                        className="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-indigo-300 dark:b/g-gray-700 dark:border-gray-600 dark:focus:ring-indigo-600 dark:ring-offset-gray-800"
                        required=""
                      />
                    </div>
