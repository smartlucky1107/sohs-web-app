...
export default function Workers() {
    ...
    return (
        <section className="w-full h-auto">
            <WorkersHero />
            <WorkersInfo />
            <WorkersTable setPopupState={setPopupState} setEditPopupState={setEditPopupState} PopupState={PopupState}  />
            <CommonContact />
            {PopupState && (
                <WorkersPopup setPopupState={setPopupState} PopupState={PopupState}  />
            )}
            {EditPopupState.visible && (
                <WorkersEditPopup setEditPopupState={setEditPopupState} EditPopupState={EditPopupState}  />
            )}
        </section>
    )
}