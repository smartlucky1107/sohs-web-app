            ...
            <div className="w-full max-w-5xl pt-10 flex justify-center flex-col gap-6">
                ...
                <div className="flex w-full flex-wrap items-center h-auto sm:gap-6 sm:flex-col-reverse"> 
                    ...
                    <div className="flex flex-col gap-3 md:w-2/3 md:pl-7">
                        <h1 className="text-3xl sm:text-1xl">Offering a Wide Variety of Occupational Health Services and Solutions</h1>
                        <p className=" text-gray-700" style={{ lineHeight: '2' }}>From pre-placement medical exams, medical testing, and independent assessments, to immunization and medical surveillance programs, we have you covered. Workplace Medical is your one-stop shop,  offering a wide range of occupational health programs that allow you to implement an integrated and comprehensive occupational health solution. The services we offer include: Medical Surveillance Programs & Periodic Medicals, Pre-Placement Medicals, On-site Medical Services, Mask Fit Testing, Drug Testing Services, Flu Programs, Company Wellness Programs, Firefighter Medicals, Driver Medical, Pilot Medical and Executive Medical.</p>
                    </div>
                </div>
            </div>
        </section>
