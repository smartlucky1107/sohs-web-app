...
export default function HomeMotto() {
  return (
    <section
      className="w-full flex justify-center align-bottom relative md:max-h-[250px]"
      style={{
    ...
    >
      <div className="w-full h-full md:max-h-[250px] p-5 pb-0 flex justify-between align-bottom items-end gap-6 sm:flex-col-reverse">
        <img
          src="/doc-2.png"
          alt="doctor"
          className="w-[300px] min-h-[400px] origin-bottom"
        />
        <div className="w-full h-full min-h-[250px] max-w-[1280px] items-center flex justify-center flex-col gap-6">
          <div className="flex gap-6 items-center sm:gap-1 w-full justify-center flex-col h-full">
            <h1 className="text-3xl sm:text-xl text-center text-white">
              Our Motto
            </h1>
            ...
            <Link className="bg-[#fff] text-black px-6 py-2" href="/contact">
              Contact Us
            </Link>
          </div>
        </div>
        <div>
          <img
            src="/sthetoscope.jpg"
            alt="doctor"
            className="max-w-[300px] sm:hidden"
          />
        </div>
      </div>
    </section>
