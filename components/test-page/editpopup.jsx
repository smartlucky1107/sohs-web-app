...
import data from "@/pages/data/tests/data.json";
...
export default function TestsEditPopup(props) {
  ...
  const handleSubmit = async () => {
    try {
      ...
      await axios.post("/api/tests/editworker", postData); // Send POST request to API
      ...
      <div className="w-full max-w-[800px] bg-white flex flex-col relative">
        ...
        <div className="w-full p-6 flex flex-wrap gap-5 justify-center items-center overflow-y-scroll max-h-[500px]">
          ...
          <Select
            ...
            onChange={(selectedValue) =>
              handleInputChange("edisc", selectedValue)
            }
          />
          <Select
            ...
            onChange={(selectedValue) =>
              handleInputChange("erop", selectedValue)
            }
          />
          <Select
            ...
            onChange={(selectedValue) =>
              handleInputChange("rine", selectedValue)
            }
          />
          <Select
            ...
            onChange={(selectedValue) =>
              handleInputChange("hear", selectedValue)
            }
          />
          <Select
            ...
            onChange={(selectedValue) =>
              handleInputChange("earp", selectedValue)
            }
          />
          <Select
            ...
            onChange={(selectedValue) =>
              handleInputChange("lnexp", selectedValue)
            }
          />
          <Select
            ...
            onChange={(selectedValue) =>
              handleInputChange("medic", selectedValue)
            }
          />
          <Select
            ...
            onChange={(selectedValue) =>
              handleInputChange("milser", selectedValue)
            }
          />
          <Select
            ...
            onChange={(selectedValue) =>
              handleInputChange("medicp", selectedValue)
            }
          />
          <Input
            size="large"
            placeholder="Med_Hist"
            style={{
              width: "40%",
            }}
          ...
          <Select
            ...
            onChange={(selectedValue) =>
              handleInputChange("counsel", selectedValue)
            }
          />
          <Select
            ...
            onChange={(selectedValue) =>
              handleInputChange("protect", selectedValue)
            }
          />
          <Input
            size="large"
          ...
          <Select
            ...
            onChange={(selectedValue) =>
              handleInputChange("demo", selectedValue)
            }
          />
          <Input
            size="large"
            placeholder="Cleanfreq"
            style={{
              width: "40%",
            }}
          ...
          <Select
            ...
            onChange={(selectedValue) =>
              handleInputChange("report", selectedValue)
            }
          />
          <Input
            size="large"
          ...
          <DatePicker
            format="DD/MM/YYYY"
            placeholder={"Date_Tested"}
            size={"large"}
            style={{
              width: "40%",
            }}
            onChange={(selectedDate) =>
              handleInputChange("dtest", selectedDate)
            }
          />
          <Select
            ...
            onChange={(selectedValue) =>
              handleInputChange("rev1y", selectedValue)
            }
          />
          <Select
            ...
            onChange={(selectedValue) =>
              handleInputChange("rev6m", selectedValue)
            }
          />
          <Select
            ...
            onChange={(selectedValue) =>
              handleInputChange("tontfy", selectedValue)
            }
          />
          <Select
            ...
            onChange={(selectedValue) =>
              handleInputChange("notfid", selectedValue)
            }
          />
